...
from EmiliaRobot import pbot as app
from EmiliaRobot import arq
from EmiliaRobot.services.keyboard import Ikb
from EmiliaRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from EmiliaRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from EmiliaRobot.services.types import InlineQueryResultCachedDocument
from EmiliaRobot.modules.info import get_chat_info, get_user_info
from EmiliaRobot.modules.music import download_youtube_audio
from EmiliaRobot.utils.functions import test_speedtest
from EmiliaRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/4f02af79c758ad092786c.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/EmiliaChanRobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Emilia](https://t.me/EmiliaChanRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/ZenitsuID)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
