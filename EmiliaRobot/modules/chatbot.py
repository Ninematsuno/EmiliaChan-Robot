...
import EmiliaRobot.modules.sql.chatbot_sql as sql
from EmiliaRobot.modules.helper_funcs.filters import CustomFilters
from EmiliaRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from EmiliaRobot import dispatcher, updater, SUPPORT_CHAT
from EmiliaRobot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Emilia Chatbot disable by {}.".format(
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(
            "https://www.kukiapi.xyz/api/apikey=KUKIg76Fg4EIo/Natsunagi/@ZenitsuID/message="
            + Message
        )
