...
from EmiliaRobot.__main__ import STATS, TOKEN, USER_INFO
from EmiliaRobot.modules.sql import SESSION
import EmiliaRobot.modules.sql.userinfo_sql as sql
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/ProjectEmilia"
                            ),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/ProjectEmilia"
                            ),
                        ],
                    ]
                ),
