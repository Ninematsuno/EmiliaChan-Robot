...
import EmiliaRobot.modules.sql.notes_sql as sql
from EmiliaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from EmiliaRobot.__main__ import DATA_IMPORT
from EmiliaRobot.modules.helper_funcs.chat_status import user_admin
from EmiliaRobot.modules.helper_funcs.alternate import typing_action

# from EmiliaRobot.modules.rules import get_rules
import EmiliaRobot.modules.sql.rules_sql as rulessql

# from EmiliaRobot.modules.sql import warns_sql as warnssql
import EmiliaRobot.modules.sql.blacklist_sql as blacklistsql
from EmiliaRobot.modules.sql import disable_sql as disabledsql

# from EmiliaRobot.modules.sql import cust_filters_sql as filtersql
# import EmiliaRobot.modules.sql.welcome_sql as welcsql
import EmiliaRobot.modules.sql.locks_sql as locksql
from EmiliaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("EmiliaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("EmiliaRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Emilia-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("EmiliaRobot{}.backup".format(chat_id))  # Cleaning file
